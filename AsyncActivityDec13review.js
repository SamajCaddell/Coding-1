...
//For example, If I pass in the number
//10 it should return the message,"this  is a positive number", or if I type in the number -12, it should return the message, "this is a negative number.
//If the usertypes in zero, it should return the message; "this is zero".

//2. You have been hired by netflix to help them develop a movie ticket program.
//Youmust create a function that will check the movie goers age and return the price of the movie ticket based on that person's age.
...
//Key Points
//create a function that will apply a discount to an items price
